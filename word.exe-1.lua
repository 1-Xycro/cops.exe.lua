...
elseif
menu == 10 then hackmenu10()
elseif
menu == 11 then hackmenu11()
elseif
menu == 12 then hackmenu12()
elseif
menu == 13 then gg.toast("Canceled")
os.exit()
end
end
...
local menu  = gg.multiChoice({
     ...
     "Increased HitSphere Ratio",
     "Increased Body Hitbox",
     "Increased Head Hitbox",
     "Rapid Fire",
     "No Recoil",
     "Less Recoil",
     "No Spread",
...
if menu[5] == true then
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("hE1 13 40 BD 0B 1C A0 4E 00 10 2E 1E", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
  gg.getResults(4)
  gg.editAll("h01F0271E", gg.TYPE_BYTE)
  gg.clearResults()
...
if menu[6] == true then
  ...
  gg.clearResults()
  gg.toast("Increased HitSphere Ratio")
end
...
gg.toast("Sniper Crosshair")
end


if menu[17] == true then

patch(set_spread,ret) 

gg.toast("No SniperBlur")
end
...
if menu[23] == true then
  ...
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber('1,069,295,862',gg.TYPE_QWORD)
  gg.getResults(1000)
  gg.editAll('-3,270,508,544',gg.TYPE_QWORD)
  gg.clearResults()
...
gg.searchNumber('1,069,295,862',gg.TYPE_QWORD)
gg.getResults(1000)
gg.editAll('1,092,616,192',gg.TYPE_QWORD)
gg.clearResults()
gg.toast("High View")
end
...
if menu[27] == true then
  ...
  gg.toast("Max Clip Size")
    ...
    patch(isreloadingpossible,true1)
end
...
if menu[3] == true then
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("2.5;4.40000009537;3.09999990463:9",gg.TYPE_FLOAT)
  gg.refineNumber("4.40000009537",gg.TYPE_FLOAT)
  gg.getResults(100000)
  v = gg.prompt({i = "[setJumpHeight] Recommended 7"}, {i = "4"})
if v == nil then
gg.clearResults()
gg.toast("Jump Height Unchanged")
else
...
if menu[7] == true then
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("5.0;3.25;2.5;2.0;10.0:17",gg.TYPE_FLOAT)
  gg.refineNumber("5",gg.TYPE_FLOAT)
  gg.getResults(100000)
  v = gg.prompt({i = "[setSpeed]Select a number Between 5 and 15"}, {i = "5"})
if v == nil then
gg.clearResults()
gg.toast("Speed Unchanged")
else
save12 = gg.getResults(4)
gg.editAll(v["i"], gg.TYPE_FLOAT, false, gg.SIGN_EQUAL,
0, -1)
...
local AccountTypes = gg.prompt({"Spectator","User","Assistant Moderator","Moderator","Veteran Moderator","Developer","Mods","Officials"},nil,{"checkbox","checkbox","checkbox","checkbox","checkbox","checkbox","checkbox","checkbox"})
 ...
 gg.setRanges(gg.REGION_ANONYMOUS)
    gg.searchNumber("209,790,697;1;1:13",gg.TYPE_DWORD)
    gg.getResults(100000)
    gg.editAll("209,790,697;0;1", gg.TYPE_DWORD)
...
gg.setRanges(gg.REGION_ANONYMOUS)
    gg.searchNumber("209,790,697;1;1:13",gg.TYPE_DWORD)
    gg.getResults(100000)
    gg.editAll("209,790,697;1;1", gg.TYPE_DWORD)
...
gg.setRanges(gg.REGION_ANONYMOUS)
    gg.searchNumber("209,790,697;1;1:13",gg.TYPE_DWORD)
    gg.getResults(100000)
    gg.editAll("209,790,697;64;1", gg.TYPE_DWORD)
...
gg.setRanges(gg.REGION_ANONYMOUS)
    ...
    gg.getResults(100000)
    v = gg.prompt({i = "[setViewModel X] -0.5 for left hand guns"}, {i = "-0.05000000075"})
if v == nil then
  gg.clearResults()
  gg.toast("ViewModel Unchanged")
else
...
function hackmenu4()
  ...
  function hackmenu5()
    ...
    if menu[1] == true then
      gg.setRanges(gg.REGION_CODE_APP)
      gg.searchNumber("-7.16042653e24F;360.0F;3.14159274101F:9",gg.TYPE_FLOAT)
    ...
    if menu[4] == true then
      gg.setRanges(gg.REGION_CODE_APP)
      gg.searchNumber("-7.16042653e24F;360.0F;3.14159274101F:93",gg.TYPE_FLOAT)
      gg.refineNumber("360",gg.TYPE_FLOAT)
          gg.getResults(10)
          gg.editAll("250", gg.TYPE_FLOAT)
          gg.clearResults()
    ...
    if menu[6] == true then
      gg.setRanges(gg.REGION_CODE_APP)
      gg.searchNumber("360.0F;57.29578018188F;0.05000000075F;180.0F:13",gg.TYPE_FLOAT)
      gg.searchNumber("360",gg.TYPE_FLOAT)
          gg.getResults(10)
          gg.editAll("1002", gg.TYPE_FLOAT)
          gg.clearResults()
          gg.toast('FOV 1002')
    end
        ...
        function hackmenu8()
          ...
          function hackmenu9()
            ...
            if menu[1] == true then
               ...
               patch(bypass27,false1)
               patch(bypass28,false1)
               patch(bypass29,false1)
               patch(bypass30,false1)
               patch(bypass31,false1)
               patch(bypass32,false1)
               patch(bypass33,false1)
               patch(bypass34,false1)
               patch(bypass35,false1)
            ...
            function hackmenu10()
              ...
              if menu[1] == true then
                ...
                Check_For_Updates = true --[[⚠️️Change This to false If you don't want the script To Check For updates. But You won't know when a new and better free script is released ]]--  
...
{"nignogs", "Offset: ","Try Harder --(decreases accuracy)","Try For 32 bit"},
{"WeaponDefData","0x18",false,false},
{"text","text","checkbox","checkbox"})
if (Get_user_input[1] == "") or (Get_user_input[2] == "") then
gg.alert("ℹ️ Don't Leave Input Blankℹ️")
goto stort
end
Get_user_type = gg.choice({"1. Byte / Boolean","2. Dword / 32 bit Int","3. Qword / 64 bit Int","4. Float","5. Double"},nil,"nignogs\n\nℹ️ Choose The Output Type ℹ️")
...
gg.sleep(1000)
 ...
 gg.clearResults()
 gg.setRanges(gg.REGION_ANONYMOUS)
 gg.searchNumber("5900000000000000r;A6110000A7110000r;661F0000671F0000r;671F0000681F0000r;681F0000AD110000r:33",gg.TYPE_QWORD)
 gg.getResults(67)
...
--T gloves
 gg.clearResults()
 gg.searchNumber("0700000000000000r;00000000B51B0000r;B51B000001000000r;010000003A1A0000r;3A1A000002000000r;0200000000000000r:21",gg.TYPE_QWORD)
 gg.getResults(100)
